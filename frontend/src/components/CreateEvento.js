...
export default function CreateEvento(){
    ...
    return(
        <form className='container' onSubmit={handleSubmit(onSubmit)}>
            <div className="row">
                <h2 className='text-dark col-12 mb-5 mt-5'>Crear evento familiar</h2>
                <div className="form-group col-12 mb-4">
                    <label className='text-dark mb-5' htmlFor="descripcion">Descripción del Evento</label>
                ...
                <div className="form-group col-12 mb-5">
                    <label className='text-dark mb-1' htmlFor="fecha_evento">Fecha del Evento</label>
                    <br/>
                    <DatePicker
                    selected={fecha}
            ...
            <button type="submit" class="btn btn-dark">Guardar Evento</button>
        </form>
    )
}